...
gen junior      = (a4_2==1&a4_3==2&a4_4==2&a4_5==2&a4_6==2&a4_7==2&a4_8==2)
gen high		= (a4_3==1&a4_4==2&a4_5==2&a4_6==2&a4_7==2&a4_8==2)
gen techhigh	= (a4_4==1&a4_5==2&a4_6==2&a4_7==2&a4_8==2)
gen college		= (a4_5==1&a4_6==2&a4_7==2&a4_8==2)
gen univ		= (a4_6==1|a4_7==1|a4_8==1)
gen tech=techhigh==1|college==1 //combine techhigh and college

gen edu_level   = edu
replace edu_level =1 if (a4_2==2&a4_3==2&a4_4==2&a4_5==2&a4_6==2&a4_7==2&a4_8==2)
...
gen IVjunior	= (a17_2==1&a17_3==2&a17_4==2&a17_5==2&a17_6==2&a17_7==2&a17_8==2)
gen IVhigh		= (a17_3==1&a17_4==2&a17_5==2&a17_6==2&a17_7==2&a17_8==2)
gen IVtechhigh	= (a17_3==2&a17_4==1&a17_5==2&a17_6==2&a17_7==2&a17_8==2)
gen IVcollege	= (a17_5==1&a17_6==2&a17_7==2&a17_8==2)
gen IVuniv		= (a17_6==1|a17_7==1|a17_8==1)
gen IVtech=IVtechhigh==1|IVcollege==1

gen edu_level_sib   = edu¡ª¡ªsib
replace edu_level_sib =1 if (a1_2==2&a1_3==2&a1_4==2&a1_5==2&a1_6==2&a1_7==2&a1_8==2)
replace edu_level_sib =2 if (junior==1)
replace edu_level_sib =3 if (high==1)
replace edu_level_sib =4 if (techigh==1)
replace edu_level_sib =5 if (college==1)
replace edu_level_sib =6 if (univ==1)

***** create a IV, and replace IVedu1 as edu_sib2 later **********
gen IVedu    = edu 
gen sIVedu   = edu_sib
gen IVedu_level = edu_level
gen sIVedu_level = edu_level_sib
